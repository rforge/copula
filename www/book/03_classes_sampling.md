---
title: Code from Chapter 3
author: Marius Hofert, Ivan Kojadinovic, Martin Mächler, Jun Yan
---

Below is the R code from Chapter 3 of the book "Elements of Copula Modeling
with R". The code is also available as an [R script](scripts/03_classes_sampling.R).
