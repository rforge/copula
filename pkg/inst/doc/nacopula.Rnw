...
%% almost as usual
\author{Marius Hofert\thanks{The first author (Willis Research Fellow) thanks Willis
...
<<ex1-str>>=
str(claytonCop) # str[ucture] of object
@
...
Next, let us evaluate this Clayton copula at $(0.5,0.5,0.5)\tr$ and near the
upper corner $(0.99,0.99,0.99)\tr$.
<<ex1-explore2>>=
...
require(lattice)
print(splom(~ U9, varnames = paste("U", 1:9, sep="_"),
            cex = 0.4, pscales = 0))
@
