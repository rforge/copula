...
objects (for more information about the statistical software \R, see \citeauthor{r}), containing as slots the corresponding generator
...
<<opwer-def3>>=
theta0 <- opow.Clayton@tauInv(2/3) 
theta1 <- opow.Clayton@tauInv(.75) 
