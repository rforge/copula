...
##' @result optimal constant m for the fast rejection algorithm
...
##' @result ACopula with theta set to value
##' @author Martin Maechler
...
##' @param int interval
##' @result parameter constraint function
##' @author Martin Maechler
