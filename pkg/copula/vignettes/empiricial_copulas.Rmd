...
As a check, plot the empirical copulas and compare each with its
implementation in `copula`.
...
As a basic test, let us check whether the mass distributions have indeed
