...
%% Now,  packageDescription("copula")[["LastChanged"]]  is too long,
%% ----> we "cheat" as follows:
<<copula-version, eval=FALSE>>=
my.strsplit(  packageDescription("copula")[["LastChanged"]]  )
@
<<copula-version,echo=FALSE>>=
cat(strsplit(packageDescription("copula")[["LastChanged"]], "; *")[[1]],"", sep="\n")
